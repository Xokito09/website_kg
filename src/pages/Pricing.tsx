          ...
          <div className="max-w-4xl mx-auto w-full relative z-10 flex flex-col items-center">
            ...
            >
              ...
              <div className="mt-8 flex flex-col gap-2 text-base md:text-lg text-gray-400 font-light max-w-2xl text-center">
                <p>
                  Outsourcing & Staffing puts a full-time contractor on your team for one flat monthly cost.
                </p>
                <p>
                  Direct Hire runs a dedicated search and charges a one-time fee only after a successful hire.
                </p>
              </div>
            </motion.div>
          </div>
